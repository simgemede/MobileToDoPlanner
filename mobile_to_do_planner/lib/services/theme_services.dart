...
class TemaServisi {
  ...
  final _anahtar = 'karanlikModMu'; // Depolamada kullanilacak anahtar
  _temayiKutuyaKaydet(bool karanlikModMu) =>
      _temaKutusu.write(_anahtar, karanlikModMu);
  ...
  void temaDegistir() {
    ...
    _temayiKutuyaKaydet(!_temaKutusundanAl()); // Temanın tersi
  }
}
